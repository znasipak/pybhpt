...
void kerr_geo_radial_roots(double &r1, double &r2, double &r3, double &r4, double const &a, double const &p, double const &e, double const &En, double const &Lz, double const &Qc);
...
double dmino_dpsi(double const &psi, double const &a, double const &p, double const &e, double const &En, double const &r3, double const&r4);
...
double dVtrdMino(double const &rp, double const &a, double const &En, double const &Lz, double const &Qc);
double dVtzdMino(double const &zp, double const &a, double const &En, double const &Lz, double const &Qc);
double dVphirdMino(double const &rp, double const &a, double const &En, double const &Lz, double const &Qc);
double dVphizdMino(double const &zp, double const &a, double const &En, double const &Lz, double const &Qc);
...
void kerr_geo_polar_mino_frequency_schw(double &LaTh, double const &Lz, double const &Qc);
...
void kerr_geo_time_mino_frequency_polar_schw(double &upT, double const &En, double const &Lz, double const &Qc, double const &z1, double const &z2);
...
void kerr_geo_azimuthal_mino_frequency_polar_schw(double &upPh, double const &a, double const &En, double const &Lz, double const &Qc, double const &z1, double const &z2);
...
void kerr_geo_mino_frequencies(double &upT, double &upR, double &upTh, double &upPh, double const &a, double const &p, double const &e, double const &x, double const &En, double const &Lz, double const &Qc, double const &r1, double const &r2, double const &r3, double const &r4, double const &z1, double const &z2);
...
void kerr_geo_time(Vector &tR, Vector &tTh, double const &upR, double const &upTh, double const &a, double const &p, double const &e, double const &x, double const &En, double const &Lz, double const &Qc, double const &r1, double const &r2, double const &r3, double const &r4, double const &z1, double const &z2);
void kerr_geo_radial_time(Vector &tR, double const &upR, double const &a, double const &p, double const &e, double const &En, double const &Lz, double const &r1, double const &r2, double const &r3, double const &r4);
void kerr_geo_polar_time(Vector &tTh, double const &upTh, double const &a, double const &x, double const &En, double const &Lz, double const &Qc, double const &z1, double const &z2);
...
Vector tp_polar_of_angle_fourier(double const &a, double const &x, double const &En, double const &Lz, double const &Qc, double const &upR, Vector const &fourier);
Vector tp_radial_of_angle_fourier(double const &a, double const &p, double const &e, double const &En, double const &Lz, double const &Qc, double const &upTh, Vector const &fourier);
Vector phip_polar_of_angle_fourier(double const &a, double const &x, double const &En, double const &Lz, double const &Qc, double const &upR, Vector const &fourier);
Vector phip_radial_of_angle_fourier(double const &a, double const &p, double const &e, double const &En, double const &Lz, double const &Qc, double const &upTh, Vector const &fourier);

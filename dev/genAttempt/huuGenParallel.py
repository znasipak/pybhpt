...
from pybhpt.redshift import Yslm, RedshiftCoefficients
...
for mm in mList:
    huuTempGen = redshift_calc_gen("IRG", lmax, geoTest, mrange=[mm, mm], krange=[-12,12], nrange=[-15,15])
    np.save("huu_m"+str(mm)+".npy", huuTempGen[1])